...
class WxPay
{
    ...
    public function pay($out_trade_no,$body,$total_fee,$url,$ip)
    {
        $return = $this->weixinapp($out_trade_no,$body,$total_fee,$url,$ip);
        return $return;
    }

    private function unifiedOrder($out_trade_no,$body,$total_fee,$notify_url,$ip)
    {
...
//            curl_setopt($ch,CURLOPT_CAINFO,$caInfo);
    ...
    private function weixinapp($out_trade_no,$body,$total_fee,$url,$ip)
    {
        $unifiedOrder = $this->unifiedOrder($out_trade_no,$body,$total_fee,$url,$ip);
